...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(arg_numMeasure)->m_StandardValueAfter.szGetConfig(szText, 250));
...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(0)->m_CalibZeroWater.szGetConfig(szText, 250));
	sPrecision = sPrecision.split("|").last().split(".").last().left(1);
...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(0)->m_CalibZeroWaterNew.szGetConfig(szText, 250));
	sPrecision = sPrecision.split("|").last().split(".").last().left(1);
...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(arg_numMeasure)->m_StandardValueBefore.szGetConfig(szText, 250));
	sPrecision = sPrecision.split("|").last().split(".").last().left(1);
...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(arg_numMeasure)->m_CalibCoeff.szGetConfig(szText, 250));
	sPrecision = sPrecision.split("|").last().split(".").last().left(1);
...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(arg_numMeasure)->m_CalibCoeffNew.szGetConfig(szText, 250));
	sPrecision = sPrecision.split("|").last().split(".").last().left(1);
...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_CalibZeroAir.szGetConfig(szText, 250));
	sPrecision = sPrecision.split("|").last().split(".").last().left(1);
...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_Delta.szGetConfig(szText, 250));
	sPrecision = sPrecision.split("|").last().split(".").last().left(1);
...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ZeroStandard.szGetConfig(szText, 250));
	sPrecision = sPrecision.split("|").last().split(".").last().left(1);
...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_AirWaterFlag.szGetConfig(szText, 250));
	sPrecision = sPrecision.split("|").last().split(".").last().left(1);
...
{
	TCHAR szText[250];
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_RawConcentration.szGetConfig(szText, 250));
	sPrecision = sPrecision.split("|").last().split(".").last().left(1);
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(arg_numMeasure)->m_StandardValueAfter.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(0)->m_CalibZeroWater.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ZeroStandard.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_AirWaterFlag.szGetLabel()
...
QString CWinMaintenanceModel::sGetMesurePHLbl()const
{
    ...
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_RawConcentration.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_CalibZeroAir.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_Delta.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(0)->m_CalibZeroWaterNew.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(arg_numMeasure)->m_StandardValueBefore.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(arg_numMeasure)->m_CalibCoeff.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(arg_numStream)->pGetAt(arg_numMeasure)->m_CalibCoeffNew.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(arg_numMeasure)->m_CalibZeroWater.szGetLabel()
...
{
    QString sLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(arg_numMeasure)->m_CalibZeroWaterNew.szGetLabel()
...
void CWinMaintenanceModel::getDataFromSupervision()
{
    ...
    m_sNameStep = QString::fromWCharArray(CElemCycle::m_CurrentStep.szGetLabel()
...
QString CWinMaintenanceModel::getTemperatureCuve()
{
    ...
    QString sRQT = QString::fromWCharArray(pElem->m_pTrameJbusRP->szGetConfig(szText, 5000));
...
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_OpticalGain.szGetLabel());

}
QString CWinMaintenanceModel::getOpticalGainUnit()const
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_OpticalGain.m_szUnit.szGetLabel());
}
...
QString CWinMaintenanceModel::getZeroOpticalMeasurementLbl()const{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ZeroOpticalMeasurement.szGetLabel());
}
QString CWinMaintenanceModel::getZeroOpticalMeasurementUnit()const{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ZeroOpticalMeasurement.m_szUnit.szGetLabel());
}
QString CWinMaintenanceModel::getOpticalMeasurementLbl()const{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_OpticalMeasurement.szGetLabel());
}
QString CWinMaintenanceModel::getOpticalMeasurementUnit()const{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_OpticalMeasurement.m_szUnit.szGetLabel());
}
