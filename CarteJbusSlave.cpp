 ...
 *****************************************************************************/
BOOL CCarteJbusSlave::bReadConfig(QString pszFileName,CListStream *pListStream)
{
	BOOL bReturn;
	...
	if (bReturn = CSerialPort::bReadConfig(pszFileName))
	{
		...
		// commande ECRITURE 
		// CMD MARCHE VOIE
        _stprintf(szText, sizeof(szText)/sizeof(TCHAR), _T("0x%08x|0x%08x|0x%08x|0x%08x|0x%08x|0x%08x|%08x|%08x"),MAKE_ID(0,0xFF,eTYPE_INT8,eID_STREAM_ACTIVE),MAKE_ID(1,0xFF,eTYPE_INT8,eID_STREAM_ACTIVE),MAKE_ID(2,0xFF,eTYPE_INT8,eID_STREAM_ACTIVE),
		...
		// CMD RUN
        _stprintf(szText, sizeof(szText)/sizeof(TCHAR), _T("0x%08x"),MAKE_ID(0xFF,0xFF,eTYPE_INT8,eID_LISTSTREAM_CMD_RUN));
		pElemFieldBit8 = (CElemFieldBit8 *)m_ListDataCanWrite.pAdd(new CElemFieldBit8());
		if (bReturn = (pElemFieldBit8 != NULL))
		{
			iCurrentPos = 0;
        ...
        _stprintf(szText, sizeof(szText)/sizeof(TCHAR), _T("0x%08x|0x%08x|0x%08x|0x%08x|0x%08x|0x%08x|%08x|%08x"),MAKE_ID(0,0xFF,eTYPE_INT8,eID_STREAM_IS_RUNNING),MAKE_ID(1,0xFF,eTYPE_INT8,eID_STREAM_IS_RUNNING),MAKE_ID(2,0xFF,eTYPE_INT8,eID_STREAM_IS_RUNNING),
        ...
        _stprintf(szText, sizeof(szText)/sizeof(TCHAR), _T("0x%08x|0x%08x|0x%08x"),MAKE_ID(0xFF,0xFF,eTYPE_INT8,eID_LISTSTREAM_CMD_RUN),MAKE_ID(0xFF,0xFF,eTYPE_INT8,eID_LISTSTREAM_CMD_PAUSE),MAKE_ID(0xFF,0xFF,eTYPE_INT8,eID_LISTSTREAM_STATE_MAINTENANCE));
		pElemFieldBit8 = (CElemFieldBit8 *)m_ListDataCanRead.pAdd(new CElemFieldBit8());
		if (bReturn = (pElemFieldBit8 != NULL))
		{
			iCurrentPos = 0;
        ...
        _stprintf(szText, sizeof(szText)/sizeof(TCHAR), _T("0x%08x|0x%08x|0x%08x"),MAKE_ID(0xFF,0xFF,eTYPE_INT8,eID_LISTSTREAM_STATE_CLEANUP),MAKE_ID(0xFF,0xFF,eTYPE_INT8,eID_LISTSTREAM_STATE_ZERO),MAKE_ID(0xFF,0xFF,eTYPE_INT8,eID_LISTSTREAM_STATE_CALIB));
		pElemFieldBit8 = (CElemFieldBit8 *)m_ListDataCanRead.pAdd(new CElemFieldBit8());
		if (bReturn = (pElemFieldBit8 != NULL))
		{
			iCurrentPos = 0;
        ...
        _stprintf(szText, sizeof(szText)/sizeof(TCHAR), _T("0x%08x|0x%08x|0x%08x|0x%08x|0x%08x|0x%08x|0x%08x|0x%08x"),
        ...
        _stprintf(szText, sizeof(szText)/sizeof(TCHAR), _T("0x%08x"),MAKE_ID(0xFF,0xFF,eTYPE_INT8,eID_LISTSTREAM_STATUS_FAILURE));
		pElemFieldBit8 = (CElemFieldBit8 *)m_ListDataCanRead.pAdd(new CElemFieldBit8());
		if (bReturn = (pElemFieldBit8 != NULL))
		{
			iCurrentPos = 0;
        ...
        _stprintf(szText, sizeof(szText)/sizeof(TCHAR), _T("0x%08x|0x%08x|0x%08x|0x%08x|0x%08x|0x%08x|%08x|%08x"),
 ...
 * @parm :	LPCSTR | szIni | fichier de configuration
 *****************************************************************************/
BOOL CCarteJbusSlave::bWriteConfig(QString pszFileName)
{
	BOOL bReturn;
