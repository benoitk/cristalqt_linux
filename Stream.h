...
public:
    ...
    BOOL bReadConfig(int iNumStream, QString pszFileName,CListStream *pListStream);
    BOOL bReadCycle(int iNumStream, QString pszFileName,CListStream *pListStream);
    BOOL bWriteConfig(int iNumStream, QString pszFileName);
...
public:
    ...
    BOOL bReadConfig(QString pszFileName);
	BOOL bReadTempConfig(LPCTSTR pszFileName);
    BOOL bReadCycle(QString pszFileName);
