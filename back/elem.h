...
public:
    ...
    virtual void GetVal(LPTSTR szVal, int iSizeMax=CONV_BUFFER_SIZE){
        _stprintf(szVal, sizeof(szVal)/sizeof(TCHAR), m_szFormat.szGetLabel(),m_fVal);
    };
...
public:
    ...
    virtual void GetVal(LPTSTR szVal, int iSizeMax=CONV_BUFFER_SIZE){_stprintf(szVal,sizeof(szVal)/sizeof(TCHAR), m_szFormat.szGetLabel(),m_ucVal);};
...
public:
    ...
    virtual void GetVal(LPTSTR szVal, int iSizeMax=CONV_BUFFER_SIZE){_stprintf(szVal,sizeof(szVal)/sizeof(TCHAR),m_szFormat.szGetLabel(),m_nVal);};
...
public:
    ...
    virtual void GetVal(LPTSTR szVal, int iSizeMax=CONV_BUFFER_SIZE){_stprintf(szVal,sizeof(szVal)/sizeof(TCHAR),m_szFormat.szGetLabel(),m_lVal);};
