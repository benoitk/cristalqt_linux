...
BOOL CMesure::bReadConfig(int iNumStream, int iNumMesure, LPCTSTR pszFileName)
{
	...
	// mesure
    _stprintf(szText2, sizeof(szText2)/sizeof(TCHAR),_T("0x%08x|Valeur mesure|0.|mV|%s"),MAKE_ID(iNumStream, iNumMesure,eTYPE_FLOAT,eID_MESURE_VAL),m_Val.m_szFormat.szGetLabel());
