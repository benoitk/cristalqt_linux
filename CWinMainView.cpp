...
//    }
    ...
    qDebug() << "#### CWinMainView::init QVBoxLayout" << endl;
    m_pModel->getNbStream();
    qDebug() << "#### CWinMainView::init m_pModel" << endl;
    i = m_pModel->getNbStream();
    qDebug() << "#### CWinMainView::init i = m_pModel-" << i << endl;
    for(i=0; i < m_pModel->getNbStream(); ++i)
	{
        qDebug() << "#### CWinMainView::init 01" << endl;
        ...
        m_listLblStatusVoie.append(lblStatusVoie);
         ...
         qDebug() << "#### m_pModel->getNbMeasure(i) " << m_pModel->getNbMeasure(i) <<endl;
