...
public:
    CWinMainView(CWinMainControler* argoControler, QWidget *parent = 0, Qt::WindowFlags = 0);
//    CWinMainView(CWinMainControler* argoControler, QWidget *parent = 0, Qt::X11BypassWindowManagerHint = 0);
    void setConnexion();
