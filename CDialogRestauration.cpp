...
//    if(bCopyFile(szGetFullPathName(SZ_FILE_CONFIG),szGetFullPathName(SZ_FILE_CONFIG_BACKUP), FALSE))
...
//    if(bCopyFile(szGetFullPathName(SZ_FILE_CONFIG_BACKUP),szGetFullPathName(SZ_FILE_CONFIG),FALSE))
