...
{
    qDebug() << "#### CWinMainControler::CWinMainControler éé" << endl;
    ...
    //Fenêtre principale
    m_pView  = new CWinMainView(this, 0, Qt::X11BypassWindowManagerHint);
...
void CWinMainControler::btAlarmPressed()
{
	if(m_pDialogAlarm->updateAlarms())
	{
        ...
        //	m_pDialogAlarm->showFullScreen();
            m_pDialogAlarm->setMinimumSize(QSize(800, 480));
            m_pDialogAlarm->show();
...
void CWinMainControler::execControler()
{
    ...
    m_pView->setMinimumSize(QSize(800, 480));
    m_pView->show();
}
