...
public:
    ...
    QString getLblDigiOut(const int& nNumDigiOut);
    QString getLblDigiIn(const int& nNumDigiOut);
    QString getLblAnalogOut(const int& nNumDigiOut);
    QVector<QString> getVectorLblDigiOut();
