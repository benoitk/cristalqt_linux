...
CWinMainModel::CWinMainModel(CSupervision* argoSupervision, CWinMainView* argoView)
{
    ...
    _stprintf(szRQ, sizeof(szRQ)/sizeof(TCHAR),_T("10|3|0x0420|2"));
    _stprintf(szRP, sizeof(szRP)/sizeof(TCHAR),_T("10|3|4|0|0|0|0"));
    ...
    _stprintf(szRQ, sizeof(szRQ)/sizeof(TCHAR),_T("10|3|0x0444|2"));
    _stprintf(szRP, sizeof(szRP)/sizeof(TCHAR),_T("10|3|4|0|0|0|0"));
	m_pSupervision->getCarteMesure()->bAddExchangeJbus(szRQ,szRP,m_pSupervision->getAnalyseur());
#ifdef SONDE	
    m_pSupervision->addKeyOnMapRQTComJBUSMesure("fMesureElectrode");
    _stprintf(szRQ, sizeof(szRQ)/sizeof(TCHAR),_T("10|3|0x0448|2"));
    _stprintf(szRP, sizeof(szRP)/sizeof(TCHAR),_T("10|3|4|0|0|0|0"));
	m_pSupervision->getCarteMesure()->bAddExchangeJbus(szRQ,szRP,m_pSupervision->getAnalyseur());
#else
	m_pSupervision->addKeyOnMapRQTComJBUSMesure("fMesureOptique");
    _stprintf(szRQ, sizeof(szRQ)/sizeof(TCHAR),_T("10|3|0x0440|2"));
    _stprintf(szRP, sizeof(szRP)/sizeof(TCHAR),_T("10|3|4|0|0|0|0"));
	m_pSupervision->getCarteMesure()->bAddExchangeJbus(szRQ,szRP,m_pSupervision->getAnalyseur());
#endif	
    ...
    m_logErrorPrgFileDir = new QDir(QString::fromWCharArray(_szLogErrorPrgFileDir));
    m_logFileDir = new QDir(QString::fromWCharArray(_szLogFileDir));
    m_logUserFileDir = new QDir(QString::fromWCharArray(_szUserLogFileDir));

	TCHAR szText[250];

    dwGetPrivateProfileString(_T("Config"), _T("NbrDayLog"),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(SZ_CONFIG_ANALYSEUR_FILE));
    QString sConfigNbrDayLog = QString::fromWCharArray(szText);//.split("|")[2];
    ...
    dwGetPrivateProfileString(_T("Config"), _T("NbrDayMeasurement"),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(SZ_CONFIG_ANALYSEUR_FILE));
    sConfigNbrDayLog = QString::fromWCharArray(szText);//.split("|")[2];
	if(sConfigNbrDayLog.count() > 3 ) //Si la ligne de conf est pas foireuse
	{
...
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_AbsorbanceValue.m_szUnit.szGetLabel());;
}
QString CWinMainModel::getAbsorbanceValueLbl()const
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_AbsorbanceValue.szGetLabel());
}
...
{
   return QString::fromWCharArray(CElemCycle::m_CurrentStep.szGetLabel()
...
void CWinMainModel::getDataFromMeasureCard()
{
 ...
 //                                           , m_pSupervision->getAnalyseur()->m_ExternalInterface));
	...
	//					    ,TRUE,TRUE , m_pSupervision->getAnalyseur()->m_ExternalInterface);*/
	//pElem =(CElemExchangeJbus*)m_pSupervision->getCarteMesure()->getListExchange()->pGetAt(m_pSupervision->getNumRQTComJBUSMesure("fPressionEau"));
    //sRQT = QString::fromWCharArray(pElem->m_pTrameJbusRP->szGetConfig(szText, 5000));
 ...
 //                                           , m_pSupervision->getAnalyseur()->m_ExternalInterface));
    ...
    //m_sOpticalGainLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_OpticalGain.szGetLabel());
	//m_nOpticalGainValue = m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_OpticalGain.nGetVal();
    //m_sOpticalGainUnit = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_OpticalGain.m_szUnit.szGetLabel());
	
    //m_sOpticalMeasurementLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_OpticalMeasurement.szGetLabel());
	//m_nOpticalMeasurementValue = m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_OpticalMeasurement.fGetVal();
    //m_sOpticalMeasurementUnit = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_OpticalMeasurement.m_szUnit.szGetLabel());
	//
    //m_sZeroOpticalMeasurementLbl = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ZeroOpticalMeasurement.szGetLabel());
	//m_nZeroOpticalMeasurementValue = m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ZeroOpticalMeasurement.fGetVal();
    //m_sZeroOpticalMeasurementUnit = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ZeroOpticalMeasurement.m_szUnit.szGetLabel());
...
{
    qDebug() << "CWinMainModel::getNbStream()const" << endl;
    if(m_pSupervision->getAnalyseur() != NULL)
        return m_pSupervision->getAnalyseur()->iGetNbrStream();
    else{
        qDebug() << "CWinMainModel::getNbStream()const pointeur null";
        return -1;
    }
}
...
QString CWinMainModel::getMesureValueUnit(int numStream, int numMeasure)const
{
	if(    m_pSupervision->getAnalyseur()->pGetAt(numStream) 
		&& m_pSupervision->getAnalyseur()->pGetAt(numStream)->pGetAt(numMeasure))
        return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(numStream)->pGetAt(numMeasure)->m_Val.m_szUnit.szGetLabel());
	else
		return "NaN";
}
QString CWinMainModel::getMesureValueLbl(int numStream, int numMeasure)const
{
	if(    m_pSupervision->getAnalyseur()->pGetAt(numStream) 
		&& m_pSupervision->getAnalyseur()->pGetAt(numStream)->pGetAt(numMeasure))
        return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(numStream)->pGetAt(numMeasure)->m_Val.szGetLabel());
	else
		return "NaN";
}
