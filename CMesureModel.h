...
public:
    ...
    QString getValLbl(){return QString::fromWCharArray(m_pMesure->m_Val.szGetLabel()
													   , m_pMesure->m_Val.lGetLabelLength());};
    QString getValUnit(){return QString::fromWCharArray(m_pMesure->m_Val.m_szUnit.szGetLabel()
