...
//	bCopyFile(szGetFullPathName(_T("InterfaceIO.ini"),szText),SZ_FIC_TEMP,FALSE);
    ...
    dwGetPrivateProfileString(_T("Config_io"), _T("BoardNumber"),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
    QString sTmp = QString::fromWCharArray(szText);
    ...
    for(int numCarte=0; numCarte<nbCarteIO; ++numCarte)
    {
        ...
        dwGetPrivateProfileString((LPCTSTR)sSectionIni.utf16(), _T("Config_Digi_Out"),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
        QString sConfigDigiOut = QString::fromWCharArray(szText);
	    QStringList sListConfigDigiOut = sConfigDigiOut.split("|");

        dwGetPrivateProfileString((LPCTSTR)sSectionIni.utf16(), _T("Config_Digi_OutSecurite"),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
        QString sConfigDigiOutSecurite = QString::fromWCharArray(szText);
	    ...
	    foreach(sConfigTemp, sListConfigDigiOut)
	    {
		    ...
		    if(sConfigTemp == "1" || sConfigTemp == "2")
		    {
                ...
                dwGetPrivateProfileString((LPCTSTR)sSectionIni.utf16(), (LPCTSTR)sLbl.utf16(),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
                m_vDigiOutLabels.append(  QString("(") + QString::number(numCarte+1) + QString(")")
                                        + QString::fromWCharArray(szText));
			    //SDx ON
                sRqtON = QString::number(numCarte+1) + QString("|5|0x7") + QString::number(nNumSDPhysique) + QString("|1|0");
                /*_stprintf(szRQ, sizeof(szRQ)/sizeof(TCHAR),_T("1|5|0x70|1|0")); sd1
                _stprintf(szRP, sizeof(szRP)/sizeof(TCHAR),_T("1|5|0x70|1|0"));*/
                _stprintf(szRQ, sizeof(szRQ)/sizeof(TCHAR), (LPCTSTR)sRqtON.utf16());
                _stprintf(szRP, sizeof(szRP)/sizeof(TCHAR), (LPCTSTR)sRqtON.utf16());
                ...
                _stprintf(szRQ, sizeof(szRQ)/sizeof(TCHAR),(LPCTSTR)sRqtOFF.utf16());
                _stprintf(szRP, sizeof(szRP)/sizeof(TCHAR),(LPCTSTR)sRqtOFF.utf16());
			    m_pSupervision->getCarteIO()->bAddExchangeJbus(szRQ,szRP,m_pSupervision->getAnalyseur());
        ...
        dwGetPrivateProfileString((LPCTSTR)sSectionIni.utf16(), _T("Config_Analog_Out"),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
        //dwGetPrivateProfileString(_T("Board_0"), _T("Config_Digi_Out"),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
        QString sConfigAnalogOut = QString::fromWCharArray(szText);
        ...
        foreach(sConfigTemp, sListConfigAnalogOut)
        {
            if(sConfigTemp == "1" || sConfigTemp == "2")
		    {
                ...
                dwGetPrivateProfileString((LPCTSTR)sSectionIni.utf16(), (LPCTSTR)sLbl.utf16(),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
                m_vAnalogOutLabels.append(QString::fromWCharArray(szText));
                ...
                qDebug() << sRqt;
                qDebug() << sRep;
                /* _stprintf(szRQ, sizeof(szRQ)/sizeof(TCHAR),_T("1|16|0x0030|02|04|0x00000414|0"));
                _stprintf(szRP, sizeof(szRP)/sizeof(TCHAR),_T("1|16|0x0030|02"));*/
                _stprintf(szRQ, sizeof(szRQ)/sizeof(TCHAR),(LPCTSTR)sRqt.utf16());
                _stprintf(szRP, sizeof(szRP)/sizeof(TCHAR),(LPCTSTR)sRep.utf16());
                m_pSupervision->getCarteIO()->bAddExchangeJbus(szRQ,szRP,m_pSupervision->getAnalyseur());
        ...
        dwGetPrivateProfileString((LPCTSTR)sSectionIni.utf16(), _T("Config_Digi_In"),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
        //dwGetPrivateProfileString(_T("Board_0"), _T("Config_Digi_Out"),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
        QString sConfigDigiIn = QString::fromWCharArray(szText);
        QStringList sListConfigDigiIn = sConfigDigiIn.split("|");
        
        dwGetPrivateProfileString((LPCTSTR)sSectionIni.utf16(), _T("Config_Digi_InSecurite"),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
        QString sConfigDigiInSecurite = QString::fromWCharArray(szText);
        ...
        foreach(sConfigTemp, sListConfigDigiIn)
        {
            if(sConfigTemp == "1" || sConfigTemp == "2")
		    {
                ...
                dwGetPrivateProfileString((LPCTSTR)sSectionIni.utf16(), (LPCTSTR)sLbl.utf16(),_T("0"),szText, sizeof(szText)/sizeof(TCHAR), szGetFullPathName(_T("InterfaceIO.ini")));
                m_vDigiInLabels.append(QString::fromWCharArray(szText));
       ...
       /* _stprintf(szRQ, sizeof(szRQ)/sizeof(TCHAR),_T("1|01|0x0060|02"));
          _stprintf(szRP, sizeof(szRP)/sizeof(TCHAR),_T("1|01|01|0x00ff0334|0xffff039f"));*/
...
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ValAna.szGetLabel()
											, m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ValAna.lGetLabelLength());
}
QString CWinExternalCardModel::getLblMesure()const
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_Val.szGetLabel()
...
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ValMaxConvertisseur.szGetLabel()
...
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ValMinConvertisseur.szGetLabel()
...
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ValAna.m_szUnit.szGetLabel()
...
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_Val.m_szUnit.szGetLabel()
...
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ValMaxConvertisseur.m_szUnit.szGetLabel()
...
{
    return QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_ValMinConvertisseur.m_szUnit.szGetLabel()
...
{
	TCHAR szText[250];
//    QString sPrecision = QString::fromWCharArray((m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_Val.szGetConfig(szText, 250)), 250);
    QString sPrecision = QString::fromWCharArray(m_pSupervision->getAnalyseur()->pGetAt(0)->pGetAt(0)->m_Val.szGetConfig(szText, 250));

    _tprintf(_T(" ################################ m_Val, %S \n"), szText);
    qDebug() << "sPrecision " << sPrecision;
//    sPrecision = QString(( const QChar *)(szText));
//    qDebug() << "sPrecision " << sPrecision;
//    sPrecision = QString::fromWCharArray(szText);
//    qDebug() << "sPrecision " << sPrecision;
//    sPrecision = sPrecision.split("|").last().split(".").last().left(1);
    sPrecision = sPrecision.split("|").last();
    qDebug() << "sPrecision " << sPrecision;
    sPrecision = sPrecision.split(".").last();
    qDebug() << "sPrecision " << sPrecision;
    sPrecision = sPrecision.left(1);
    qDebug() << "sPrecision " << sPrecision;
...
{
    if(m_listNumCarteSA.count() > arg_numSortie)
...
QString CWinExternalCardModel::getLblDigiOut(const int& nNumDigiOut){
    if(m_vDigiOutLabels.count() > nNumDigiOut)
        return m_vDigiOutLabels.at(nNumDigiOut);
    else
        return "Num Digit Out NaN";
}
QString CWinExternalCardModel::getLblDigiIn(const int& nNumDigiOut){
    if(m_vDigiInLabels.count() > nNumDigiOut)
        return m_vDigiInLabels.at(nNumDigiOut);
    else
        return "Num Digit In NaN";
}

QString CWinExternalCardModel::getLblAnalogOut(const int& nNumDigiOut){
    if(m_vAnalogOutLabels.count() > nNumDigiOut)
        return m_vAnalogOutLabels.at(nNumDigiOut);
    else
        return "Num Analog Out NaN";
}

QVector<QString> CWinExternalCardModel::getVectorLblDigiOut(){
    return m_vDigiOutLabels;
}
