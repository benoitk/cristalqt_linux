...
void CWinElecTestView::init()
{
	...
	////*** Onglet RELAIS
    qDebug() << "*** onglet RELAIS";
	QWidget* widgetRelais = new QWidget();
	m_layoutCentralRelais = new QFormLayout();
    qDebug() << "### for(int i=0; (i < m_pModelExternalCard->getNbDigitOut( ";
    ...
    qDebug() << "### FIN  for(int i=0; (i < m_pModelExternalCard->getNbDigitOut( ";
